...
public class GitHubClient {
    ...
    public List<Item> search(double lat, double lon, String keyword) {
        ...
        // Create a custom response handler (lambda function)
...
//            Item[] items = mapper.readValue(inputStream, Item[].class);
            // by using Jackson, we reduce the amount of potential errors
            // increased type safety
            // our item response is an array
...
//            return Arrays.asList(items);
        ...
        // we return the same empty list everytime to prevent accidental changes to what we return
        // plus, we can check if the return is empty so we know nothing went wrong???
        return Collections.emptyList();
    }
