(function () {
    // $('#linkedIn').attr('href','https://github.com/FengYou97');
    // $('#link').attr('href','https://github.com/FengYou97');
    // $('#link').attr('href','https://github.com/FengYou97');
    /**
     * Variables
     */
    ...
    function init() {
        ...
        document.querySelector('#linkedIn').addEventListener('click', function() {
            document.location.href = 'https://www.linkedin.com/in/feng-you-155477ba/';
        });
        document.querySelector('#email').addEventListener('click', function() {
            document.location.href = 'mailto:fengus97@gmail.com';
        });
        document.querySelector('#github').addEventListener('click', function() {
            document.location.href = 'https://github.com/FengYou97';
        });
        validateSession();
